...
const TextInputcomponent = () => {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <Text style={styles.title}>Email TextInput Example</Text> <TextInput
                style={styles.input}
            ...
            <Text style={styles.title}>Multiline TextInput Example</Text> <TextInput
            ...
            />
            <Text style={styles.output}>Message: {message}</Text> </ScrollView>
    );
};
